...
const styles: Record<string, React.CSSProperties> = {
  ...
  info: { flex: 1 },
  name: { color: '#fff', fontSize: 20, fontWeight: 700, marginBottom: 8, display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' },
  meta: { color: 'rgba(255,255,255,0.45)', fontSize: 15, marginBottom: 8 },
  niche: { color: 'rgba(255,255,255,0.65)', fontSize: 15, fontStyle: 'italic', marginTop: 6, lineHeight: 1.6 },
